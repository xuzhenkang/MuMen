...
public class MsgAdapter extends BaseAdapter {
	...
	public List<MsgDianEntity> mListEntity = null;
	...
	public MsgAdapter(Context context) {
		...
		mListEntity = new ArrayList<MsgDianEntity>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final MsgDianEntity entity = (MsgDianEntity) getItem(position);
		...
		if (convertView == null) {
			...
			case 0:
				...
				convertView = mInflater.inflate(R.layout.row_msg_list, null);

				holder1 = new Holder1();

				holder1.time = (TextView) convertView
						.findViewById(R.id.row_msg_txt_time);

				holder1.title = (TextView) convertView
						.findViewById(R.id.row_msg_txt_title);
		...
		holder1.time.setText(entity.post_time);

		return convertView;
	}

	public void setData(List<MsgDianEntity> list) {

		mListEntity.addAll(list);
		notifyDataSetChanged();
	}

	public void setData2(List<MsgDianEntity> list) {
		for (int i = 0; i < list.size(); i++) {
			MsgDianEntity entity = new MsgDianEntity();
			entity = list.get(i);
