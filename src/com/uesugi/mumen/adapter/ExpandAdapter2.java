...
public class ExpandAdapter2 extends BaseAdapter {
	// /**
	// * 标题的item
	// */
	...
	public ExpandAdapter2(Context context, FinalBitmap fb) {
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			case 0:
				...
				convertView = mInflater
						.inflate(R.layout.row_expand_list2, null);

				holder1 = new Holder1();

				holder1.pict1 = (ImageView) convertView
						.findViewById(R.id.row_expand_imgv_img1);
				...
				holder1.pict2 = (ImageView) convertView
						.findViewById(R.id.row_expand_imgv_img2);
				holder1.name2 = (TextView) convertView
						.findViewById(R.id.row_expand_txt_name2);
				holder1.bg2 = (ImageView) convertView
						.findViewById(R.id.row_expand_imgv_bg2);
		...
		if (pp * 2 < mListEntity.size()) {
			...
			final ArticleEntity entity1 = (ArticleEntity) getItem(pp * 2);
		...
		if ((pp * 2) + 1 < mListEntity.size()) {
			...
			final ArticleEntity entity2 = (ArticleEntity) getItem((pp * 2) + 1);
			...
			holder1.bg2.setVisibility(View.INVISIBLE);
		}
