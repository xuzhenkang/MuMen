...
import com.lecloud.lecloudsdkdemo.MutlLiveActivity;
...
public class PromotionActivity extends FinalActivity {
	...
	RelativeLayout mLayoutLivingNone;

	@ViewInject(id = R.id.promotion_txt_tab1, click = "btnTab1")
	private TextView mTextTab1;
	@ViewInject(id = R.id.promotion_txt_tab2, click = "btnTab2")
	private TextView mTextTab2;
	@ViewInject(id = R.id.promotion_txt_tab3, click = "btnTab3")
	private TextView mTextTab3;
	@ViewInject(id = R.id.promotion_txt_tab4, click = "btnTab4")
	...
	@ViewInject(id = R.id.promotion_layout_1)
	private RelativeLayout mLayoutTab1;
	@ViewInject(id = R.id.promotion_layout_2)
	private RelativeLayout mLayoutTab2;
	@ViewInject(id = R.id.promotion_layout_3)
	private RelativeLayout mLayoutTab3;
	@ViewInject(id = R.id.promotion_layout_4)
	...
	@ViewInject(id = R.id.promotion_imgv_huodong, click = "btnLive")
	private ImageView mImgVHuodong;

	private LiveListEntity mEntity2;

	@ViewInject(id = R.id.promotion_txt_huodong_title)
	...
	private void initView() {
		 ...
		 */
		mPullDownView1 = (PullDownView) findViewById(R.id.promotion_pull_down_view1);
		...
		// Constants.width, (int) (Constants.width * 0.47f)));
		// mLayoutHd.setLayoutParams(new LinearLayout.LayoutParams(
		// Constants.width, (int) (Constants.width * 0.47f)));
		 ...
		 * 1.使用PullDownView 2.设置OnPullDownListener 3.从mPullDownView里面获取ListView
		 */
		mPullDownView3 = (PullDownView) findViewById(R.id.promotion_pull_down_view3);
		...
		mImgVHuodong
				.setLayoutParams(new RelativeLayout.LayoutParams(
						Constants.width - DisplayUtil.dip2px(mContext, 30),
						(int) ((Constants.width - DisplayUtil.dip2px(mContext,
								30)) * 0.47f)));
	}
	...
	public void getTitleList() {
		...
		RemoteUtils.getTitle("1", new WHTTHttpRequestCallBack() {
			...
			public void result(Object obj) {
				...
				if (!entity.success) {
					...
					mTextTab2.setText(entity.list.get(1).title);
					mTextTab3.setText(entity.list.get(2).title);
					mTextTab4.setText(entity.list.get(3).title);
					id1 = entity.list.get(0).id;
					id2 = entity.list.get(1).id;
					id3 = entity.list.get(2).id;
					id4 = entity.list.get(3).id;
					getList1();
					getPic();
				}
	...
	public void getList2() {
		...
		RemoteUtils.getLive(new WHTTHttpRequestCallBack() {

			@Override
			public void result(Object obj) {
				// TODO Auto-generated method stub
				mDialog.dismissProgressDlg();
				LiveListEntity entity = (LiveListEntity) obj;

				if (!entity.success) {

					mLayoutLivingNone.setVisibility(View.VISIBLE);

				} else {

					mLayoutLivingNone.setVisibility(View.GONE);
	...
	public void btnLive(View v) {
		if (mEntity2 == null || mEntity2.list.size() == 0) {
			return;
		}
		Log.e("activityId", mEntity2.list.get(0).cloud_id);
		Intent intent = new Intent(mContext, MutlLiveActivity.class);
		intent.putExtra("activityId", mEntity2.list.get(0).cloud_id);
		startActivity(intent);
	}
	...
	private void initLive() {
		...
		mTextTitle.setText(mEntity2.list.get(0).title);
		mTextContent.setText(mEntity2.list.get(0).content);
		if (!StringUtils.isBlank(mEntity2.list.get(0).icon)) {

			mFinalBitmap.display(mImgVHuodong, mEntity2.list.get(0).icon);
