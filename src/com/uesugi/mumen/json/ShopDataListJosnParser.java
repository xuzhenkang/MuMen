...
public class ShopDataListJosnParser {
	...
	public ShopDataListEntity parser() {
			...
			if (entity.success) {
				...
				try {
					...
					for (int i = 0; i < listArray.length(); i++) {
						...
						ShopDataEntity itemEntity = new ShopDataEntity();
						...
						itemEntity.value = itemOjbect.getString("value");
