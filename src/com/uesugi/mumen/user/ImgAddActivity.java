...
public class ImgAddActivity extends FinalActivity {
	...
	public void btnRight(View v) {
		...
		if (Constants.addBitmap1 != null) {
			String fileName1 = FileUtils.createFileName() + "add1.jpg";
			temp1 = new File(Constants.IMAGE_CACHE_PATH, fileName1);
			FileUtils.savePhoto(Constants.addBitmap1, temp1);
		}
		if (Constants.addBitmap2 != null) {
			String fileName2 = FileUtils.createFileName() + "add2.jpg";
			temp2 = new File(Constants.IMAGE_CACHE_PATH, fileName2);
			FileUtils.savePhoto(Constants.addBitmap2, temp2);
		}
		if (Constants.addBitmap3 != null) {
			String fileName3 = FileUtils.createFileName() + "add3.jpg";
			temp3 = new File(Constants.IMAGE_CACHE_PATH, fileName3);
			FileUtils.savePhoto(Constants.addBitmap3, temp3);
		}
		if (Constants.addBitmap4 != null) {
			String fileName4 = FileUtils.createFileName() + "add4.jpg";
			temp4 = new File(Constants.IMAGE_CACHE_PATH, fileName4);
			FileUtils.savePhoto(Constants.addBitmap4, temp4);
		}
		if (Constants.addBitmap5 != null) {
			String fileName5 = FileUtils.createFileName() + "add5.jpg";
			temp5 = new File(Constants.IMAGE_CACHE_PATH, fileName5);
			FileUtils.savePhoto(Constants.addBitmap5, temp5);
		}
		// 开始上传
		...
		if (requestCode == Constants.REQUEST_MORE_CAMERA
			...
			try {
				...
				if (mImgIndex.equals("1")) {
					Constants.addBitmap1 = photo;
				} else if (mImgIndex.equals("2")) {
					Constants.addBitmap2 = photo;
				} else if (mImgIndex.equals("3")) {
					Constants.addBitmap3 = photo;
				} else if (mImgIndex.equals("4")) {
					Constants.addBitmap4 = photo;
				} else if (mImgIndex.equals("5")) {
					Constants.addBitmap5 = photo;
				}
