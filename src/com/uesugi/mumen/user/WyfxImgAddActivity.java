...
public class WyfxImgAddActivity extends FinalActivity {

	private final static String TAG = "ImgAddActivity";
	...
	public void btnRight(View v) {
		...
		if (Constants.wyfxBitmap1 != null) {
			String fileName1 = FileUtils.createFileName() + "add21.jpg";
			temp1 = new File(Constants.IMAGE_CACHE_PATH, fileName1);
			FileUtils.savePhoto(Constants.wyfxBitmap1, temp1);
		}
		if (Constants.wyfxBitmap2 != null) {
			String fileName2 = FileUtils.createFileName() + "add22.jpg";
			temp2 = new File(Constants.IMAGE_CACHE_PATH, fileName2);
			FileUtils.savePhoto(Constants.wyfxBitmap2, temp2);
		}
		if (Constants.wyfxBitmap3 != null) {
			String fileName3 = FileUtils.createFileName() + "add23.jpg";
			temp3 = new File(Constants.IMAGE_CACHE_PATH, fileName3);
			FileUtils.savePhoto(Constants.wyfxBitmap3, temp3);
		}
		if (Constants.wyfxBitmap4 != null) {
			String fileName4 = FileUtils.createFileName() + "add24.jpg";
			temp4 = new File(Constants.IMAGE_CACHE_PATH, fileName4);
			FileUtils.savePhoto(Constants.wyfxBitmap4, temp4);
		}
		if (Constants.wyfxBitmap5 != null) {
			String fileName5 = FileUtils.createFileName() + "add25.jpg";
			temp5 = new File(Constants.IMAGE_CACHE_PATH, fileName5);
			FileUtils.savePhoto(Constants.wyfxBitmap5, temp5);
		}
		// 开始上传
		...
		RemoteUtils.upDateIcon(temp1, temp2, temp3, temp4, temp5,
				new WHTTHttpRequestCallBack() {
					...
					public void result(Object obj) {
						...
						if (entity.success) {
							Constants.wyfxUploadEntity= entity;
	...
	private void initView() {
		...
		if (Constants.wyfxBitmap4 != null) {
			mImgV4.setImageBitmap(Constants.wyfxBitmap4);
			mImgV5.setVisibility(View.VISIBLE);
		}
		if (Constants.wyfxBitmap5 != null) {
			mImgV5.setImageBitmap(Constants.wyfxBitmap5);
		...
		if (requestCode == Constants.REQUEST_MORE_CAMERA
			...
			try {
				...
				if (mImgIndex.equals("1")) {
					Constants.wyfxBitmap1 = photo;
				} else if (mImgIndex.equals("2")) {
					Constants.wyfxBitmap2 = photo;
				} else if (mImgIndex.equals("3")) {
					Constants.wyfxBitmap3 = photo;
				} else if (mImgIndex.equals("4")) {
					Constants.wyfxBitmap4 = photo;
				} else if (mImgIndex.equals("5")) {
					Constants.wyfxBitmap5 = photo;
				}
